...
public class ModConfig {
    ...
    public static class CommonConfig {
        ...
        // Feature toggles
        public final ModConfigSpec.BooleanValue enableQuestSystem;
        public final ModConfigSpec.BooleanValue showQuestNotifications;
        public final ModConfigSpec.BooleanValue showQuestProgress;
        public final ModConfigSpec.BooleanValue enableEventTracking;
        ...
        public CommonConfig(ModConfigSpec.Builder builder) {
            ...
            enableQuestSystem = builder
                .comment("Enable automatic quest detection from NPC responses")
                .define("enableQuestSystem", true);

            showQuestNotifications = builder
                .comment("Show chat notifications when quests are added or completed")
                .define("showQuestNotifications", true);

            showQuestProgress = builder
                .comment("Show progress notifications for kill quests")
                .define("showQuestProgress", true);

            enableEventTracking = builder
                .comment("Track player events (advancements, kills) for NPC context")
                .define("enableEventTracking", true);

            eventExpiryMinutes = builder
                .comment("How long player events stay relevant (minutes)")
                .defineInRange("eventExpiryMinutes", 5, 1, 60);
